...
import { characterFilter, addFilterText } from '../../redux/charactersSlice'
...
const SearchPanel = (state) => {
    ...
    const searchImg = <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    const handleInputChange = (e) => {
        ...
        dispatch(addFilterText(searchText))
        dispatch(characterFilter(searchText));
    };
